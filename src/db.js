...
// создаем в памяти мобильного устройства БД с именем post.db
// храниться она будет по адресу ${FileSystem.documentDirectory}/SQLite/${name}
...
export class DB {
  ...
  static init() {
    return new Promise((resolve, reject) => {
      db.transaction(tx => {
        tx.executeSql( // https://docs.expo.io/versions/v38.0.0/sdk/sqlite/
